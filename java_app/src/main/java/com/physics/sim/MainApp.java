...
public class MainApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Controls
        gravitySlider = new Slider(1, 20, 9.81);
        gravitySlider.setShowTickLabels(true);
        gravitySlider.setPrefWidth(160);
        ...
        stage.setTitle("Physics Simulator - Enhanced");
    ...
    private void updateStatus() {
        int count = nativeWorld.getBodyCount();
        lblStatus.setText(String.format("Bodies: %d | Gravity: %.1f", count, gravitySlider.getValue()));
    }
